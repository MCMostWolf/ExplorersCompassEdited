...
public class NewWayPoint {
    public static void addPoint(int x, int z, PlayerEntity player, String structureName) {
        ...
        Waypoint instant = new Waypoint(x, (int) player.getPosY(), z, structureName, structureName.substring(0,1), (int)(Math.random() * ModSettings.ENCHANT_COLORS.length), 0, false);
