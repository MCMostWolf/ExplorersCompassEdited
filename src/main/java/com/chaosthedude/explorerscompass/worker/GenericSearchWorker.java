...
public class GenericSearchWorker extends StructureSearchWorker<StructurePlacement> {
	...
	public GenericSearchWorker(ServerLevel level, Player player, ItemStack stack, BlockPos startPos, StructurePlacement placement, List<ConfiguredStructureFeature<?, ?>> configuredStructureSet, String managerId, List<Pair<UUID, ChunkPos>> foundChunks) {
